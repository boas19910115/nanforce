 ...
 */
function lili_blog_sanitize_checkbox( $checked ) {
	// Boolean check.
 ...
 */
function lili_blog_sanitize_select( $input, $setting ) {
 ...
 *                    the setting default.
 */
function lili_blog_sanitize_number_range( $number, $setting ) {
 ...
 *  @since Springy 1.0.0
 */
if (!function_exists('lili_blog_sanitize_number')) :
    function lili_blog_sanitize_number($input)
    {
