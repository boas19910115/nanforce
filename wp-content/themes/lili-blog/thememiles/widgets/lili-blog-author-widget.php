...
if (!class_exists('Lili_Blog_Author_Widget')) :

    /**
     *
     * @since Lili Blog 1.0.0
     */
    class Lili_Blog_Author_Widget extends WP_Widget
    {
         private function defaults()
        {
            $defaults = array(
                'title'              => esc_html__( 'TM: About Me', 'lili-blog' ),
                'author_description' => esc_html__( 'Author Description goes here.', 'lili-blog' ),
                'author_image'       =>'',
                'author_facebook'    => esc_html__( '#', 'lili-blog' ),
                'author_twitter'     => esc_html__( '#', 'lili-blog' ),
                'author_linkedin'    => esc_html__( '#', 'lili-blog' ),
                'author_instagram'   => esc_html__( '#', 'lili-blog' ),
                'author_pinterest'   => '',
                'author_youtube'     => esc_html__( '#', 'lili-blog' ),
                'author_vk'          => '',
                'author_sign'        =>'',
           );
            return $defaults;
        ...
        {
            $opts = array(
                'classname' => 'lili_blog_widget_author',
                'description' => esc_html__('Display Author Profile.', 'lili-blog'),
            );
            parent::__construct('lili-blog-author', esc_html__('TM: Lili Blog Author', 'lili-blog'), $opts);
        }
            ...
            <div class="author-profile text-center">
                ...
                <div class="author-wrap">
                    ...
                    if (isset($author_image) && !empty($author_image)) {
                        ?>
                        <figure class="fig" style=" background-image: url(<?php echo esc_url($instance['author_image']); ?>);"> 
                        </figure>
                    <?php
                    }
                    ?>
                    ...
                    <?php if ($author_facebook || $author_twitter || $author_linkedin || $author_instagram || $author_pinterest || $author_youtube || $author_vk || $author_sign) { ?>
                        <ul class="menu social-links mb-20">
                                ...
                                <li>
                                    <a href="<?php echo esc_url($author_facebook); ?>" target="_blank">
                                        <span class="screen-reader-text">
                                            <?php esc_html_e('facebook', 'lili-blog'); ?>  
                                        </span>
                            ...
                            <?php if ($author_twitter) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_twitter); ?>" target="_blank">
                                        <span class="screen-reader-text">
                                            <?php esc_html_e('twitter', 'lili-blog'); ?>
                                        </span>
                            ...
                            <?php if ($author_linkedin) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_linkedin); ?>" target="_blank">
                                        <span class="screen-reader-text">
                                            <?php esc_html_e('linkedin', 'lili-blog'); ?>
                                        </span>
                            ...
                            <?php if ($author_instagram) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_instagram); ?>" target="_blank">
                                        <span class="screen-reader-text">
                                            <?php esc_html_e('instagram', 'lili-blog'); ?>
                                        </span>
                            ...
                            <?php if ($author_pinterest) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_pinterest); ?>" target="_blank">
                                        <span class="screen-reader-text">
                                            <?php esc_html_e('pinterest', 'lili-blog'); ?>
                                        </span>
                            ...
                            <?php if ($author_youtube) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_youtube); ?>" target="_blank">
                                        <span class="screen-reader-text">
                                            <?php esc_html_e('youtube', 'lili-blog'); ?>
                                        </span>
                            ...
                            <?php if ($author_vk) { ?>
                                <li>
                                    <a href="<?php echo esc_url($author_vk); ?>" target="_blank">
                                        <span  class="screen-reader-text">
                                            <?php esc_html_e('vk', 'lili-blog'); ?>
        ...
        public function form($instance)
        {
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('title')); ?>"><strong><?php esc_html_e('Title:', 'lili-blog'); ?></strong></label>
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('author_description')); ?>"><strong><?php esc_html_e('Description:', 'lili-blog'); ?></strong></label>
            ...
            <p>
                <label for="<?php echo $this->get_field_id('author_image'); ?>">
                    <?php _e('Select Image: Recommended size 250*250', 'lili-blog'); ?>
                </label>
                <br/>
                <?php
                ...
                <input type="button" class="button button-primary custom_media_button" id="custom_media_button"
                       name="<?php echo $this->get_field_name('author_image'); ?>"
                       value="<?php esc_attr_e('Upload Image', 'lili-blog') ?>"/>
            </p>
            ...
            <p>
                <label
                    for="<?php echo esc_attr($this->get_field_id('author_sign')); ?>"><strong><?php esc_html_e('Author Sign Text:', 'lili-blog'); ?></strong></label>
...
add_action('admin_enqueue_scripts', 'lili_blog_widgets_backend_enqueue');
function lili_blog_widgets_backend_enqueue()
{
    wp_register_script('lili-blog-custom-widgets', get_template_directory_uri() . '/assets/js/widgets.js', array('jquery'), true);
    
    wp_enqueue_media();
    wp_enqueue_script('lili-blog-custom-widgets');
}